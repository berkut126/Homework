...
public class OpenAPIDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .termsOfServiceUrl("https://github.com/berkut126/Homework/tree/Java")
                .version("0.0.2")
                .contact(new Contact("","", "berkut126@gmail.com"))
                .build();
    }
    ...
    public OpenAPI openApi() {
        return new OpenAPI()
                .info(new Info()
                        .title("Расписание")
                        .description("Расписание")
                        .termsOfService("https://github.com/berkut126/Homework/tree/Java")
                        .version("0.0.2")
                        .license(new License()
                                .name("BSD-2-Clause")
